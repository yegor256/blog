...
**Breaking News**: 12 projects were already selected as candidates for the winner.
All others have no chances this year. The list is at [the bottom](#11) of the page.
...
158 rojects submitted so far (in order of submission):
...
[email me](mailto:yegor@teamed.io).
...
Here is what I found, preliminarly.
...
[coala-analyzer/coala](https://github.com/coala-analyzer/coala) (14K Python LoC, 160K HoC)
  ...
  * There are global functions, for example
    [`get_language_tool_results`](https://github.com/coala-analyzer/coala/blob/master/bears/linters/LanguageToolBear.py#L9)
    and [`DictUtilities`](https://github.com/coala-analyzer/coala/blob/master/coalib/misc/DictUtilities.py).
  ...
  * Checking object types in runtime is a
    ...
    e.g. [`ClangCountVectorCreator.py`](https://github.com/coala-analyzer/coala/blob/master/bears/codeclone_detection/ClangCountVectorCreator.py#L92)
  * What's wrong with [`cindex.py`](https://github.com/coala-analyzer/coala/blob/master/coalib/bearlib/parsing/clang/cindex.py)?
...
[checkstyle/checkstyle](https://github.com/checkstyle/checkstyle) (83K Java LoC, 553K HoC)
  ...
  * There is a [whole bunch](https://github.com/checkstyle/checkstyle/tree/master/src/main/java/com/puppycrawl/tools/checkstyle/utils) of utility classes,
    ...
    a bad thing in OOP. They are even groupped into a special `utils` package,
  ...
  * `NULL` is actively used, in many places &mdash;
    it's a serious [anti-pattern]({% pst 2014/may/2014-05-13-why-null-is-bad %})
  * I've found five `.java` files with over 1000 lines in each of them,
    for example 2500+ in [`ParseTreeBuilder.java`](https://github.com/checkstyle/checkstyle/blob/master/src/test/java/com/puppycrawl/tools/checkstyle/checks/javadoc/ParseTreeBuilder.java)
...
[citiususc/hipster](https://github.com/citiususc/hipster) (5K Java LoC, 64K HoC)
  ...
  * `NULL` is used actively, especially in iterators &mdash;
...
[suseika/inflectible](https://github.com/suseika/inflectible) (5K LoC, 36K HoC)
...
[testinfected/molecule](https://github.com/testinfected/molecule) (10K LoC, 43K HoC)
  ...
  * There are not so many issues and most of commits are not
    ...
    [`b4143a0`](https://github.com/testinfected/molecule/commit/b4143a0d15023c4fc259678e2f15698c77f3a76f) &mdash;
...
Thus, we have these best projects, out of 158 submitted to the competition:
  ...
  1. [suseika/inflectible](https://github.com/suseika/inflectible): **winner!**
...
Congratulations to the [@suseika](https://github.com/suseika), the winner!
Here is your badge:

<img src="http://img.teamed.io/award/2015/winner.png" style="width:338px;height:75px;"/>

Put this code into Github `README`:

{% highlight text %}
<img src="http://img.teamed.io/award/2015/winner.png"
  style="width:338px;height:75px;"/>
{% endhighlight %}
