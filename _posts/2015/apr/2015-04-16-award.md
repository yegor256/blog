...
[`checkstyle/checkstyle`](https://github.com/checkstyle/checkstyle) (83K Java LoC, 553K HoC)
  ...
  * `NULL` is actively used, in many places&mdash;it's a serious [anti-pattern]({% pst 2014/may/2014-05-13-why-null-is-bad %})
...
[`citiususc/hipster`](https://github.com/citiususc/hipster) (5K Java LoC, 64K HoC)
  ...
  * `NULL` is used actively, especially in iterators&mdash;it's a [bad idea]({% pst 2014/may/2014-05-13-why-null-is-bad %})
...
[`testinfected/molecule`](https://github.com/testinfected/molecule) (10K LoC, 43K HoC)
  ...
  * There are not so many issues and most of commits are not
    ...
    [`b4143a0`](https://github.com/testinfected/molecule/commit/b4143a0d15023c4fc259678e2f15698c77f3a76f)&mdash;why it was made? Not clear. Also, there are almost no pull request. Looks
...
<img src="http://img.teamed.io/award/2015/winner.png" style="width:203px;height:45px;"/>
