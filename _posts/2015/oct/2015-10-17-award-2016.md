...
60 projects submitted so far (in random order):
  ...
  * [skinny-framework/skinny-framework](https://github.com/skinny-framework/skinny-framework) by [@seratch](https://github.com/seartch)
...
[`paypal/squbs`](https://github.com/paypal/squbs) (28K LoC, 163K HoC)
  ...
  * Exception swallowing seems to be a common practice here, for example:
    [here](https://github.com/paypal/squbs/blob/master/squbs-zkcluster/src/main/scala/org/squbs/cluster/ZkCluster.scala#L119),
    [here](https://github.com/paypal/squbs/blob/master/squbs-admin/src/main/scala/org/squbs/admin/MBeanUtil.scala#L101),
    [here](https://github.com/paypal/squbs/blob/master/squbs-pattern/src/main/scala/org/squbs/pattern/util/ConfigUtil.scala#L83), etc.
  * There are utility classes, for example
    [`ConfigUtil`](https://github.com/paypal/squbs/blob/master/squbs-unicomplex/src/main/scala/org/squbs/unicomplex/ConfigUtil.scala).
  * Overall impression is that the complexity is rather high, for example
    these files are really hard to understand:
    [`ServiceRegistry.scala`](https://github.com/paypal/squbs/blob/master/squbs-unicomplex/src/main/scala/org/squbs/unicomplex/streaming/ServiceRegistry.scala)
    or [`UnicomplexBoot.scala`](https://github.com/paypal/squbs/blob/master/squbs-unicomplex/src/main/scala/org/squbs/unicomplex/UnicomplexBoot.scala).
...
<img src="http://www.yegor256.com/images/award/2016/winner-pholser.png" style="width:203px;height:45px;"/>
&nbsp;
<img src="http://www.yegor256.com/images/award/2016/winner-sils.png" style="width:203px;height:45px;"/>
