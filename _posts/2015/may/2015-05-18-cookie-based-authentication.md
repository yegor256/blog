...
reusable, we have the [`TkAuth`](https://javadoc.io/static/org.takes/takes/1.1/org/takes/facets/auth/TkAuth.html)
...
valid [`Identity`](https://javadoc.io/static/org.takes/takes/1.1/org/takes/facets/auth/Identity.html)
...
[`PsCookie`](https://javadoc.io/static/org.takes/takes/1.1/org/takes/facets/auth/PsCookie.html)
uses an instance of
[`Codec`](https://javadoc.io/static/org.takes/takes/1.1/org/takes/facets/auth/codecs/Codec.html)
...
[`RqAuth`](https://javadoc.io/static/org.takes/takes/1.1/org/takes/facets/auth/RqAuth.html),
a utility decorator of [`Request`](https://javadoc.io/static/org.takes/takes/1.1/org/takes/Request.html):
...
[`PsChain`](https://javadoc.io/static/org.takes/takes/1.1/org/takes/facets/auth/PsChain.html)
implements [`Pass`](https://javadoc.io/static/org.takes/takes/1.1/org/takes/facets/auth/Pass.html)
and attempts to authenticate the user by asking all encapsulated passes,
one by one. The first one in the chain is
[`PsFake`](https://javadoc.io/static/org.takes/takes/1.1/org/takes/facets/auth/PsFake.html).
...
tell [`PsByFlag`](https://javadoc.io/static/org.takes/takes/1.1/org/takes/facets/auth/PsByFlag.html)
that this request authenticates a user.

`PsByFlag` will iterate through all encapsulated "pairs" and try to find the
right one.
[`PsFacebook`](https://javadoc.io/static/org.takes/takes/1.1/org/takes/facets/auth/social/PsFacebook.html)
