...
Programmer in \emph{\href{https://www.huawei.com}{Huawei}} (Russia) since 2019.

Creator of \href{https://www.eolang.org}{EO}, an object-oriented \emph{programming language}.

Founder and CEO of \emph{\href{https://www.zerocracy.com}{Zerocracy}} since 2016.

Inventor of eXtremely Distributed Software Development (\href{https://www.xdsd.org}{XDSD}).

Author of \emph{\href{https://www.yegor256.com/elegant-objects.html}{Elegant Objects}},
  an OOP book series, and \href{https://www.yegor256.com/books.html}{a few others}.

Part-time \emph{lecturer} in \href{https://www.hse.ru/en/}{HSE}
...
Hands-on Java/C++/Ruby programmer
  (5K+ \emph{\href{https://github.com/yegor256}{GitHub}} followers).

Regular contributor to \emph{Stack Overflow}
...
Author of a few academic CS \emph{publications}
  (e.g. \href{https://link.springer.com/chapter/10.1007/978-3-642-02152-7_6}{this}),
  h-index: \href{https://scholar.google.com/citations?user=cYmXh60AAAAJ}{8}.
...
Regular \emph{blogger} at \href{https://www.yegor256.com/}{yegor256.com} since 2014.

Creator of \href{https://www.zold.io}{Zold}, a cryptocurrency without Blockchain.

Organizer of \href{https://www.iccq.ru}{\emph{ICCQ}},
  a computer science conference in-coop w/IEEE.

Founder and sponsor of \href{https://www.kaicode.org}{\emph{KaiCode}},
  an festival of open source projects.

Proud holder of \emph{\href{https://github.com/yegor256/blog/blob/master/pdf/certifications/OCMJEA-Feb11.pdf}{SCEA}} and
  \emph{\href{https://github.com/yegor256/blog/blob/master/pdf/certifications/PMP-Jun07.pdf}{PMP}} certifications,
...
Active on
  \href{https://www.youtube.com/c/yegor256}{YouTube} (41K+),
  \href{https://twitter.com/intent/follow?screen_name=yegor256}{X} (13K+),
  and
  \href{https://www.linkedin.com/in/yegor256}{LinkedIn} (7K+).
