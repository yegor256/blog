...
description:
  ...
  to understand software engineering; there are plenty
...
There are plenty of books about software engineering, but few of them
are my favorite. All of them I read over and over again. I will update
this post in the future, when I stumble upon something decent.

<!--more-->

I tried to put the most important at the top of the list.
...
recommend to read it a few times. Before reading, try to forget everything
you've heard about programming before. Try to start from scratch. Maybe it will
work for you too :)
...
by Rita Mulcahy.
This book is my favorite about project management. Even though it's about
...
The book perfectly explains the philosophy of testing and contradicts
many common myths about it.
...
All you need to know about your unit testing is in this book. I didn't include
famous
...
into this list, because I don't like it at all. You definitely should read
it, just to know what's going on, but it won't help you to write good tests.
...
by Michael Feathers.
It's an awesome reading about modern software development, its pitfalls and
typical failures. Most of the code we're working now is legacy (aka open source).
...
by by Jez Humble and David Farley.
It is a perfect book about software delivery, continuous integration,
testing, packaging, versioning and many other techniques around programming.
Definitely a must-read for everybody who is serious about software engineering.
...
It's a practical guide for Git, a version control system. Read it from
...
by David Flanagan.
JavaScript is a language of modern Web and this book explains it very well.
No matter what kind of software you develop, you must know JavaScript.
...
[CSS: The Definitive Guide: The Definitive Guide](http://www.amazon.com/gp/product/B00457X7L8/ref=as_li_tl?ie=UTF8&camp=1789&creative=390957&creativeASIN=B00457X7L8&linkCode=as2&tag=yegor256com-20&linkId=PSW6X7D2VCCBS6OL)
by Eric A. Meyer.
CSS is a not just about colors and shadows and it's not only for graphic designers.
CSS a key language of the modern Web. Every developer must know it, either
you're working with a back-end or front-end or desktop applications in C++.
...
it gives a lot of theoretical knowledge about concurrency in general. Highly
recommend to read it at least once.

{% badge /images/2015/04/book-xml.jpg 96 http://www.amazon.com/gp/product/0596007647/ref=as_li_tl?ie=UTF8&camp=1789&creative=390957&creativeASIN=0596007647&linkCode=as2&tag=yegor256com-20&linkId=MWLP356M3CQZSBS7 %}
...
XML is my favorite standard. And I hated it before I read this book. It is very
well written and easy to read. It's a must for everybody.
...
by by Steve McConnell.
It's just a bible of clean coding. Read it a few times and use as a reference
manual in debates with your colleagues.
...
by Steve McConnell.
It's an interesting read about software engineering and it's most tricky part &mdash; estimations.
Read it at least to be aware of the problem and possible solutions.
...
It's an old and very good book. You won't use anything from it in your
real projects, but you will get the philosophy of use cases, which will
turn your mind into the right direction. Don't take this book as something
practical, these use cases are hardly used now anywhere, but the idea of
...
[Software Requirements, 3rd Edition](http://www.amazon.com/gp/product/B00JDMPMOA/ref=as_li_tl?ie=UTF8&camp=1789&creative=390957&creativeASIN=B00JDMPMOA&linkCode=as2&tag=yegor256com-20&linkId=PRSWJK34HNP355LK)
by Karl Wiegers (Author) and Joy Beatty.
A perfect book about requirements analysis, the first and the most important
